...
func GenerateKey(bits int) (pri *PrivateKey, errs error) {
	n, p, q, err := GeneratePCPrimeWithRandom(rand.Reader, bits)
	if err != nil {
		return nil, err
	}
	pri, errs = GeneratePCKey(n, p, q)
	return
}
...
// GeneratePCKey ---
func GeneratePCKey(n, p, q *big.Int) (*PrivateKey, error) {
...
//GeneratePCPrimeWithRandom with random source random (for example, crypto/rand.Reader).
func GeneratePCPrimeWithRandom(random io.Reader, bits int) (n *big.Int, p *big.Int, q *big.Int, err error) {
...
// GeneratePCPrime --------
func GeneratePCPrime(bits int) (n *big.Int, p *big.Int, q *big.Int, err error) {
	random := rand.Reader
	return GeneratePCPrimeWithRandom(random, bits)
}
